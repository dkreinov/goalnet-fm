...
ctx columns: [home_elo, away_elo, elo_diff, home_form, away_form, form_diff] (elo/400 scaled; form =
mean points/game over last 5, 0..3). Read-only.
...
def main():
    ...
    for mid, date, hc, ac, hg, ag in rows:
        ...
        mids.append(mid)
        ctx.append([eh / 400.0, ea / 400.0, (eh - ea) / 400.0, fh, fa, fh - fa])
